...
imageRouter.handleImagesByCity(app, Image);
imageRouter.handleImagesByCountry(app, Image);
imageRouter.handlePageIndex(app, Image);
imageRouter.handleImagesByCountryCount(app, Image);
imageRouter.handleImagesByCountryHtml(app, Image);
imageRouter.handleAllImagesHtml(app, Image);
imageRouter.handleSingleImageHtml(app, Image);
